...
public class OpenglActivity extends Activity
	...
	float left_eye_pupil_x,left_eye_pupil_y,right_eye_pupil_x,right_eye_pupil_y;
				...
				if (faces != null) {
					...
					if (faces.length >= 0) {
						for (int c = 0; c < faces.length; c++) {
							...
							left_eye_pupil_x = faces[c].points[9].x;
							left_eye_pupil_y = faces[c].points[9].y;
							right_eye_pupil_x = faces[c].points[0].x;
							right_eye_pupil_y = faces[c].points[0].y;
						...
						left_eye_pupil_x = 0.0f;
						left_eye_pupil_y = 0.0f;
						right_eye_pupil_x = 0.0f;
						right_eye_pupil_y = 0.0f;
					}
					if (isFaceProperty)
						...
						public void run() {
							...
							*/
							...
							debugInfoText.setText("cameraWidth: " + mICamera.cameraWidth + "\ncameraHeight: "
									...
									// + "\nlandmarkTime: " + landmarkTime +
									// "ms"
									+ "\nleft_eye_pupil.x:" + left_eye_pupil_x
									+ "\nleft_eye_pupil.y:" + left_eye_pupil_y
									+ "\nright_eye_pupil.x:" + right_eye_pupil_x
									+ "\nright_eye_pupil.y:" + right_eye_pupil_y);
