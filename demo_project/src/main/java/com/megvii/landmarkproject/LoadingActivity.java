package com.megvii.landmarkproject;
...
public class LoadingActivity extends Activity {
	...
	private boolean isDebug, isBackCamera, isStartRecorder, isROIDetect, is106Points, isFaceProperty;
	...
	private void network() {
		...
		String content = licenseManager.getContent(uuid, LicenseManager.DURATION_365DAYS, apiName);
	...
	private void onClickListener() {
		...
		findViewById(R.id.load_layout_intoBtn).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				startActivity(new Intent(LoadingActivity.this, OpenglActivity.class).putExtra("isdebug", isDebug)
